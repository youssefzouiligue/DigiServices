...
import { addTicket, api } from '../../store/ticketsSlice';
...
const AjouterTicket = () => {
  ...
  // هاد الفنكسيون كتراجع الفورم كامل، وكتتأكد باللي العنوان
  // ، الوصف، الاسم، والإيميل مدخلين وبالصيغة الصحيحة،
  //  وإذا كان شي خطأ كيتخزن ويتعرض للمستخدم.
  const validateForm = () => {
    const newErrors = {};
...
// هاد الدالة كتتبع التغييرات فـ inputs، 
// كتحدّث البيانات ديال الفورم، وكتحيد رسالة الخطأ مباشرة إلا المستخدم صحّح القيمة.
...
// عند الضغط على  كنمنعو  إعادة تحميل الصفحة، كنراجع المعطيات، وإذا كانت صحيحة كننشئ  جديد
//  وكنصيفطو للـ  وإذا نجحات العملية كنضيفوه فـ  وكنمشي لصفحة التذاكر،
//  وإذا وقعات شي مشكلة كنبيّنو رسالة خطأ.
